...
def main():
    ...
    eval_env = make_vec_env(
        lambda: make_snake_env(**env_kwargs, rank=1000),  # Different seed for eval
        n_envs=min(4, resource_config.n_envs),
        vec_env_cls=DummyVecEnv,  # Always use DummyVecEnv for eval
    )
